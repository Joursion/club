            ...
            <div className="activity-info">
                ...
                <Col xs={24} sm={24} md={18} lg={18} className="activity-detail">
                    ...
                    <div className="activity-other">
                        <span className="creator">{activity.creator}&nbsp;</span>创建于：&nbsp;{date} &nbsp;&nbsp;<Icon type="user" /> {activity.join} &nbsp;<Icon type="message" /> &nbsp;{activity.comment}&nbsp; <Icon type="eye-o" /> &nbsp;{activity.pv}
                        {
                            isCreator ? ( 
                    ...
                    <Col xs={24} sm={24} md={24} lg={24} className="activity-show-img">
